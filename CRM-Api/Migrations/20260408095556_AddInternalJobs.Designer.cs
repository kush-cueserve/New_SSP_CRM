...
namespace CRM_Api.Migrations
{
    ...
    [Migration("20260408095556_AddInternalJobs")]
    partial class AddInternalJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRM_Api.Models.Entities.Customer.CustomerType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 495, DateTimeKind.Local).AddTicks(3577)
                        },
                        new
                        {
                            Id = 2,
                            CustomerTypeNM = "Company",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6282)
                        },
                        new
                        {
                            Id = 3,
                            CustomerTypeNM = "Sole Proprietor",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6295)
                        },
                        new
                        {
                            Id = 4,
                            CustomerTypeNM = "Trust",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6297)
                        },
                        new
                        {
                            Id = 5,
                            CustomerTypeNM = "AKA",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6298)
                        },
                        new
                        {
                            Id = 6,
                        ...
                        new
                        {
                            Id = 7,
                            CustomerTypeNM = "SMSF",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6299)
                        },
                        new
                        {
                            Id = 8,
                            CustomerTypeNM = "Staff",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6300)
                        },
                        new
                        {
                            Id = 9,
                            CustomerTypeNM = "Supplier",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6301)
                        },
                        new
                        {
                            Id = 10,
                            CustomerTypeNM = "Other",
                            UpdateDateTime = new DateTime(2026, 4, 8, 15, 25, 55, 496, DateTimeKind.Local).AddTicks(6302)
                        });
                });
